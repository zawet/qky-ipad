    ...
    series : [
        {
            ...
            center: ['46%', '50%'],
            data:[
                {value:5, name:'低体重',itemStyle:{normal: {color:'#55b9f4'}},},
                {value:5, name:'超重',itemStyle:{normal: {color:'#fc9139'}},},
                {value:5, name:'肥胖',itemStyle:{normal: {color:'#ddd'}},},
                {value:25, name:'正常',itemStyle:{normal: {color:'#027fb6'}},},
            ],
            itemStyle: {
                emphasis: {
                    shadowBlur: 10,
